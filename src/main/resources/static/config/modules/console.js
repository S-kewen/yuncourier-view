...
$(document).ready(function() {
    $.ajax({
        url:"//courier-api.iskwen.com/api/getEchatsInfoByPerformance?nowDate="+getDay(0),
        type:"POST",
        dataType: "json",
        async: false,
    ...
    $.ajax({
        url:"//courier-api.iskwen.com/api/getEchatsInfoByApiType",
        type:"POST",
        dataType: "json",
        async: false,
        headers: {'Authorization': getCookie("token")},
        success:function(msg){
            if(msg.status==0){
                ...
                api_link_num=msg.api_link_num;
                api_line_num=msg.api_line_num;
            }else{
                showTip("Echars接口異常,請重新登錄後再試");
            }
        },
    ...
    $.ajax({
        url:"//courier-api.iskwen.com/api/getEchatsInfoByPay?nowDate="+getDay(0),
        type:"POST",
        dataType: "json",
        async: false,
        headers: {'Authorization': getCookie("token")},
