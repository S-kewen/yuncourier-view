var task_refreshUnreadMessage = window.setInterval('refresh()',60000*5);//刷新未讀消息
var task_checkToken = window.setInterval('checkToken()',60000);//刷新未讀消息
$(document).ready(function() {
    $.ajax({
        url : "//courier-api.iskwen.com:8888/api/checkToken",
        type : "post",
        dataType:"json",
    ...
    $.ajax({
        url : "//courier-api.iskwen.com:8888/api/getIndexInfo",
        type : "post",
        dataType:"json",
        headers: {'Authorization': getCookie("token")},
        success:function(msg){
